...
import com.hysonwayne.nahpiattendance.MyGroup.dialogs.LoadSaveChangesDialog;
import com.hysonwayne.nahpiattendance.MyGroup.dialogs.LoadSavePresetAsDialog;
...
public class LoadPreset extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		int id = v.getId();
		if (id == R.id.bLoadPreset) {/*if(tvCurrentPreset.getText().toString().equals(radio[checkedRadio].getText().toString())){
		...
		} else if (id == R.id.bViewPreset) {
			String presetName = radio[checkedRadio].getText().toString();

			Intent data = new Intent(this, com.hysonwayne.nahpiattendance.MyGroup.ViewPreset.class);
	...
	public void savePreset(){
		if(getIntent().getBooleanExtra("presetLoaded", false)){
			DbHelper db = new DbHelper(this);
			db.open();
			db.updatePreset(tvCurrentPreset.getText().toString(), (ArrayList<com.hysonwayne.nahpiattendance.MyGroup.UpdateObj>)getIntent().getSerializableExtra("updateList"));
			db.close();
